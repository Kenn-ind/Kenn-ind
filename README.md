...
{
    public string Name        = "Kaindra-Naufal";
    public string Role        = "Unity Game Developer";
    public string Location    = "Bali/Gianyar/Sukawati";
    public string[] Passion   = { "Game Design", "Gameplay Programming" };
...
[![Portfolio](https://img.shields.io/badge/🌐_Portfolio-000000?style=for-the-badge)](https://websitemu.com)
[![Email](https://img.shields.io/badge/Email-EA4335?style=for-the-badge&logo=gmail&logoColor=white)](mailto:kaindrautama753@gmail.com)
...
```
"Stay consistent, ship anyway, iterate later. Done is better than perfect — but great is still the goal." 
```
